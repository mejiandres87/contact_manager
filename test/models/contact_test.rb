...
class ContactTest < ActiveSupport::TestCase
  ...
  test "Name should be valid" do
    @user = User.first
    @contact = Contact.new(name: '%', birthdate: Date.parse('1987-05-19'),
  ...
  test "Phone number should be valid" do
    @user = User.first
    @contact = Contact.new(name: 'Valid name', birthdate: Date.parse('1987-05-19'),
  ...
  test "Contact email must be unique for user" do
    @user = User.first
    temp_contact =Contact.create(name: 'Valid name', birthdate: Date.parse('1987-05-19'),
                              phone_number: '(+57) 310 477 07 18', address: 'Cra 11 # 95 - 37',
                              cc_mask: '4111111111111111', email: 'test@email.com', user: @user)
    @contact = Contact.new(name: 'Valid name', birthdate: Date.parse('1987-05-19'),
                          phone_number: '(+57) 310 477 07 18', address: 'Cra 11 # 95 - 37',
